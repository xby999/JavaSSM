                ...
                <div class="ibox-content">
                    ...
                    <div class="jqGrid_wrapper">
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <!--数据体 开始-->
                            <tbody>
                            <c:forEach items="${adime_delete_video_list}" var="videoInfo">
                                <tr class="gradeX">
                                    <td>${videoInfo.video_id}</td>
                                    <td>${videoInfo.video_title}</td>
                                    <td>${videoInfo.video_delete_date}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/VideoController/adminrebackVideo.action?video_id=${videoInfo.video_id}"><button type="button">还原</button></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
