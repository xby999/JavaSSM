                ...
                <div class="ibox-content">
                    ...
                    <div class="jqGrid_wrapper">
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <!--数据体 开始-->
                            <tbody>
                            <c:forEach items="${delete_audiolist}" var="audioInfo">
                                <tr class="gradeX">
                                    <td>${audioInfo.audio_id}</td>
                                    <td>${audioInfo.audio_title}</td>
                                    <td>${audioInfo.audio_delete_date}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/AudioController/adminrebackAudio.action?audio_id=${audioInfo.audio_id}"><button type="button">还原</button></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
