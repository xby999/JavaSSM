        ...
        <div class="col-sm-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>商户账户信息查询（该方式数据假分页，只要替换tr数据即可，小数据量表格适用）</h5>
                </div>
                <div class="ibox-content">
                    ...
                    <div class="jqGrid_wrapper">
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <!--数据体 开始-->
                            <tbody>
                            <c:forEach items="${list}" var="businessUser">
                                <tr class="gradeX">
                                    <td>${businessUser.business_id}</td>
                                    <td>${businessUser.business_info_name}</td>
                                    <td>${businessUser.business_info_id}</td>
                                    <td>${businessUser.business_info_legal_person_tel}</td>
                                    <td class="center">${businessUser.business_info_legal_person}</td>
                                    <td class="center">${businessUser.business_username}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                            <!--数据体 结束-->
