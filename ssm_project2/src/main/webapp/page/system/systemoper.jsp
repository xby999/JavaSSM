                ...
                <div class="ibox-content">
                    ...
                    <div class="jqGrid_wrapper">
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <c:forEach items="${list}" var="sysuse">
                                <tr class="gradeX">
                                    <td>${sysuse.user_id}</td>
                                    <td>${sysuse.user_true_name}</td>
                                    <td>${sysuse.user_tel}</td>
                                    <td class="center">${sysuse.user_sex}</td>
                                    <td class="center">${sysuse.login_user_name}</td>
                                </tr>
                            </c:forEach>
