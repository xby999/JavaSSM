                ...
                <div class="ibox-content">
                    ...
                    <div class="jqGrid_wrapper">
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <!--数据体 开始-->
                            <tbody>
                            <c:forEach items="${audiolist}" var="audioInfo">
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/AudioController/deleteAudio.action?audio_id=${audioInfo.audio_id}"><button type="button">删除</button></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
